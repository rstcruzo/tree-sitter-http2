...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [43] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(134),
  [46] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(105),
  [49] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(48),
  [52] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_request_repeat1, 2),
  [54] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_request_repeat1, 2),
  [56] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_request_repeat1, 2), SHIFT_REPEAT(19),
  ...
  [75] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_request_repeat1, 2), SHIFT_REPEAT(19),
  [78] = {.entry = {.count = 1, .reusable = true}}, SHIFT(88),
  [80] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_response, 2),
  ...
  [98] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_url, 2),
  ...
  [185] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_json_body, 5),
  ...
  [194] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_json_body, 2),
  [196] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 3),
  [198] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__key_value_list, 1),
  [200] = {.entry = {.count = 1, .reusable = true}}, SHIFT(77),
  [202] = {.entry = {.count = 1, .reusable = true}}, SHIFT(131),
  [204] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__key_value_list_repeat1, 2),
  [206] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__key_value_list_repeat1, 2), SHIFT_REPEAT(77),
  ...
  [215] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_json_body, 4),
  [217] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_json_list, 3),
  ...
  [224] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_query_params, 1),
  [226] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_query_param, 1, .production_id = 2),
  ...
  [234] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_json_body, 3),
  [236] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 2),
  [238] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__key_value_list, 2),
  ...
  [262] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_url_encoded_body, 1),
  [264] = {.entry = {.count = 1, .reusable = true}}, SHIFT(11),
  [266] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__json_list_values, 2),
  [268] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__json_list_values_repeat1, 3),
  [270] = {.entry = {.count = 1, .reusable = true}}, SHIFT(109),
  [272] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__key_value_list_repeat1, 3),
  ...
  [279] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_query_param, 3, .production_id = 5),
  [281] = {.entry = {.count = 1, .reusable = true}}, SHIFT(22),
  [283] = {.entry = {.count = 1, .reusable = true}}, SHIFT(21),
  [285] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__json_list_values_repeat1, 2), SHIFT_REPEAT(11),
  [288] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__json_list_values_repeat1, 2),
  [290] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_url_encoded_body, 2),
  [292] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method_url, 2),
  [294] = {.entry = {.count = 1, .reusable = true}}, SHIFT(104),
  [296] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_json_key_value, 3, .production_id = 4),
  [298] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__json_list_values, 1),
  [300] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_http_version, 2),
  [302] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method, 1),
  ...
  [310] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_url, 6),
  [312] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_url_encoded_key_value, 3, .production_id = 4),
  ...
  [322] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_json_body, 1),
  [324] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method_url, 3),
  [326] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_reason_phrase, 1),
  [328] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__json_key, 3),
  ...
  [342] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_header, 3, .production_id = 1),
