...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(102)] = 1373,
  [SMALL_STATE(103)] = 1378,
  ...
  [SMALL_STATE(143)] = 1551,
  [SMALL_STATE(144)] = 1555,
  [SMALL_STATE(145)] = 1559,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [59] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(104),
  ...
  [159] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_path_repeat1, 2), SHIFT_REPEAT(99),
  ...
  [169] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_json_list, 5),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_json_body, 5),
  [173] = {.entry = {.count = 1, .reusable = false}}, SHIFT(68),
  [175] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rest_of_line, 1),
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_query_params_repeat1, 2),
  [179] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_query_params_repeat1, 2), SHIFT_REPEAT(41),
  [182] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_json_list, 4),
  [184] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 3),
  [186] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_json_body, 2),
  [188] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__key_value_list_repeat1, 2),
  [190] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__key_value_list_repeat1, 2), SHIFT_REPEAT(76),
  [193] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__key_value_list, 1),
  [195] = {.entry = {.count = 1, .reusable = true}}, SHIFT(76),
  [197] = {.entry = {.count = 1, .reusable = true}}, SHIFT(124),
  [199] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_json_body, 4),
  ...
  [209] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_query_params, 2),
  [211] = {.entry = {.count = 1, .reusable = true}}, SHIFT(41),
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_json_list, 3),
  ...
  [228] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_json_body, 3),
  [230] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__key_value_list, 2),
  ...
  [242] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_url_encoded_body, 1),
  ...
  [264] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__key_value_list_repeat1, 3),
  ...
  [282] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method_url, 2),
  [284] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_url_encoded_body, 2),
  [286] = {.entry = {.count = 1, .reusable = true}}, SHIFT(19),
  [288] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_json_key_value, 3, .production_id = 3),
  [290] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__json_list_values, 1),
  [292] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_http_version, 2),
  ...
  [304] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_url_encoded_key_value, 3, .production_id = 3),
  [306] = {.entry = {.count = 1, .reusable = true}}, SHIFT(30),
  [308] = {.entry = {.count = 1, .reusable = true}}, SHIFT(42),
  [310] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_reason_phrase, 1),
  ...
  [318] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_json_body, 1),
  [320] = {.entry = {.count = 1, .reusable = true}}, SHIFT(112),
  [322] = {.entry = {.count = 1, .reusable = true}}, SHIFT(36),
  [324] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__key_value_list, 3),
  [326] = {.entry = {.count = 1, .reusable = true}}, SHIFT(66),
  [328] = {.entry = {.count = 1, .reusable = true}}, SHIFT(59),
  [330] = {.entry = {.count = 1, .reusable = true}}, SHIFT(52),
  [332] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_header, 3, .production_id = 1),
  [334] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__json_key, 3),
